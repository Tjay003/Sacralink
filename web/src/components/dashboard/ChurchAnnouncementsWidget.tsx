 ...
 * - Clicking a card opens the AnnouncementDetailModal inline
 * - "View all" still navigates to the church detail page
 */
                            ...
                            >
                                <div className="flex items-start justify-between gap-3">
                                    <div className="flex-1 min-w-0">
                                        <h4 className="font-medium text-foreground group-hover:text-orange-600 transition-colors mb-1 line-clamp-1">
                                            {announcement.title}
                                        </h4>
                                    ...
                                    <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-orange-500 transition-colors flex-shrink-0 mt-1" />
                                </div>
                            </button>
                        ))}
                    </div>
