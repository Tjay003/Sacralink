...
- [x] **Step 1 - Submit Application**:
  - [x] Log in as test user (`user6@gmail.com`).
  - [x] Navigate to [http://localhost:5173/churches/apply](http://localhost:5173/churches/apply).
  - [x] Fill in parish details: Parish Name, Address, Contact Number, GCash/Maya numbers.
  - [x] Select/drag location coordinates on the Leaflet map pin picker.
  - [x] Attach dummy files (PDF or JPG) for:
    - [x] CBCP Clergy ID / Celebret
    - [x] Diocesan Chancery Appointment Decree
  - [x] Submit the form. Confirm success confirmation screen appears.
- [x] **Step 2 - Super Admin Review Queue**:
  - [x] Log in as Super Admin (`user1@gmail.com`).
  - [x] Open [http://localhost:5173/admin/applications](http://localhost:5173/admin/applications).
  - [x] Confirm new submission appears under the **Pending** tab.
- [x] **Step 3 - Verification Audit & Approval**:
  - [x] Click **Review** on the application card.
  - [x] Verify document viewer preview opens both Celebret and Chancery decree correctly.
  - [x] Complete the 3 audit checklist checkboxes (Rectory call, Celebret verified, Merchant name matched).
  - [x] Click **Approve Application**.
- [x] **Step 4 - Directory Verification & Post-Verification Audit**:
  - [x] Go to [http://localhost:5173/churches](http://localhost:5173/churches).
  - [x] Confirm the newly approved parish appears in the public directory with the green **[Verified Parish]** badge.
  - [x] Open its detail page and confirm cashless donations are active.
  - [x] In the Verified tab at `/admin/applications`, button clearly shows **Review** with read-only audit record view.
...
- [ ] **Step 2 - Verify Recommendation Cards**:
...
### Test Steps
- [ ] **Step 1 - Real-Time Synchronization**:
...
- [ ] **Step 2 - Jitsi Video Consultation**:
